...
async function sendPasswordResetEmail(email, token) {
            ...
            <table width="480" cellpadding="0" cellspacing="0" style="max-width:480px;width:100%;">
              ...
              <tr>
                <td align="center" style="padding-bottom:30px;">
                  ...
                  <h1 style="color:#ffffff;font-size:24px;font-weight:900;margin:8px 0 0;">Quizmaster</h1>
                </td>
              </tr>
              <!-- Card -->
              <tr>
              ...
              <tr>
                <td align="center" style="padding-top:24px;">
                  <p style="color:#6366f1;font-size:12px;margin:0;">Quizmaster &mdash; De leukste quiz-app!</p>
                </td>
              </tr>
            </table>
          </td>
  ...
  await transporter.sendMail({
    ...
    to: email,
    subject: 'Wachtwoord resetten - Quizmaster',
    html,
  });
}
